...
app.layout = ds.html.Div(children=[
    ds.html.H1(children='Athlete Monitoring: Example',
    ...
    ds.html.Div([
                ds.html.Div([
                    ...
                    ds.html.Div(id='gs_output_container'),
                ]),
                ds.html.Div(
                    ds.html.Button('Generate', id='gen_graph', n_clicks=0)),
                ]),
    #draws Graphs
    ds.dcc.Graph(
        id='example-graph',
